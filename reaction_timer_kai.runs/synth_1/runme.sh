...
HD_PWD='C:/Reaction_Timer/reaction_timer_kai.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log audioHintOutput.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source audioHintOutput.tcl
