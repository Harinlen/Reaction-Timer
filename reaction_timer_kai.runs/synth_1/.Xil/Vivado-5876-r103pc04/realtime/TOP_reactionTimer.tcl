...
set rt::rc [catch {
  uplevel #0 {
    ...
    set ::env(RT_TMP) "C:/ass1/reaction_timer_kai.runs/synth_1/.Xil/Vivado-5876-r103pc04/realtime/tmp"
    ...
    set rt::SDCFileList C:/ass1/reaction_timer_kai.runs/synth_1/.Xil/Vivado-5876-r103pc04/realtime/TOP_reactionTimer_synth.xdc
    rt::sdcChecksum
    set rt::top TOP_reactionTimer
