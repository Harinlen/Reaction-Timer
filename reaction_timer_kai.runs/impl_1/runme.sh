...
HD_PWD='C:/Reaction_Timer/reaction_timer_kai.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log audioHintOutput.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source audioHintOutput.tcl -notrace
